...
//  Swiftpractice
//
//  Created by Brennan Hogue on 3/6/22.
//
...
func getPetOpinion(pet: Pets) {
    switch pet {
    case .cats:
        print("I would hate having a cat.")
    case .dogs:
        print("I would really like to have a dog.")
    case .rats:
        print("Rats are gross.")
    case .hamsters:
        print("I have owned a hamster before and liked it.")
    case .fish:
        print("I would not be able to own a fish.")
    }
}
...
switch pet {
case .hamsters, .dogs:
    print("I think that would be a good pet for a child.")
default:
    print("I would not recommend this pet for a child.")
}
