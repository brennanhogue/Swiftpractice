...
//  Swiftpractice
//
//  Created by Brennan Hogue on 3/1/22.
//
...
if theAnswerToEverything == 42 {
    print("Correct! The answer to life, the universe, and everything iis 42!")
}   else {
...
//One equals sign means the value is being set. Two equals signs means it is checking if the value is true.
...
func coldWarmOrHot(guess: Int) -> String {
    ...
    if difference == 0 {
        message = "That's insane, Wayne! You've guessed the number exacly and burned yourself! 🔥 "
